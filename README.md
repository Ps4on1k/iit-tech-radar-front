...
При внесении изменений в код frontend обновляй версию в [`package.json`](./package.json) согласно правилам семантического версионирования:
...
3. **ИБ** (фильтр: есть уязвимости / нет уязвимостей) — отображается красный восклицательный знак ⚠️ если у технологии есть хотя бы одна уязвимость в поле `securityVulnerabilities`
4. Обновление (сортировка по близости дедлайна, фильтр: дата)
5. Категория (сортировка, фильтр: dropdown)
6. Риск (сортировка, фильтр: dropdown)
7. Лицензия (сортировка, фильтр: текст)
8. Тип (сортировка, фильтр: dropdown)
9. Подтип (сортировка, фильтр: dropdown)
10. Владелец (сортировка, фильтр: текст)
